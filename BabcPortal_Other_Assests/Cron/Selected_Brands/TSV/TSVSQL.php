			...
			foreach ($apiData as $apiDataKey => $apiDataValue) {
                ...
                if(isset($apiDataValue['Pack']))
		        {
                    foreach($apiDataValue['Pack'] as $pacKey => $pacVal){
                        ...
                        $sql = "INSERT INTO ProductTSVDemo(ProductNo,Description,Category,StandardPrice,HVL,MVL,VariantCode,AmountPerUnit,CountryOfOrigin,SupplierNo,SuppliersProductNo,PurchaseCurrencyCode,Weight,Volyme,Code5,Code6,PurchasePrice,Season,DeliveryCode,CategoryDescription,VariantDescription,VariantNo,DimensionDescription,DimensionCode,price_sek_pre,price_sek_after,price_sek_consumer,price_dkk_pre,price_dkk_after,price_dkk_consumer,price_nok_pre,price_nok_after,price_nok_consumer,price_eur_pre,price_eur_after,price_eur_consumer,TX1,TX2,TX3,TX4,TX5,TX6,TX7,TX8,TX9,TX10,TX11,TX12,TX13,TX14,TX15,ModelAndVariantNo,ModelNo , Code1 , SKU , Quantity , PackType , ProductGroup3)
                        ...
                        $stmt->bindParam(':ProductGroup3', $apiDataValue['ProductGroup3'] , PDO::PARAM_STR);
                        $stmt->execute();
                    }

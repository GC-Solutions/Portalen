                ...
                <div class="page-title-breadcrumb">
                    <ol class="breadcrumb breadcrumb-admin page-breadcrumb pull-left" style="margin: 5px 10px">
                        <li>
                            ...
                            <a class="parent-item" href="<?php echo baseUrl; ?>addtwotable"><i class="fa fa-plus"></i> Add 2Tables</a>
                        </li>
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table class="table table-hover table-checkable order-column full-width" id="example4">
                            ...
                            <tbody>
                            <?php if ($getAll2Tables) { ?>
                                <?php foreach ($getAll2Tables as $key => $eachtable) {   ?>
                                    <tr >
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="<?php echo baseUrl; ?>addtwoTable?id=<?= $eachtable['ID']; ?>"
                                               href="" class="btn btn-tbl-edit btn-xs">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="<?php echo baseUrl; ?>deletetwotables?id=<?= $eachtable['ID']; ?>"

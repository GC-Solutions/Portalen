                ...
                <div class="card-body" id="bar-parent1">
                    <form action="<?php echo baseUrl; ?>saveDataSource" method="post" class="form-horizontal">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="DBType" class="form-control" required="">
                                        ...
                                        <?php if(isset($getAllAdminDB)) { 
                                            foreach($getAllAdminDB as $ke => $vals){?>
                                                <option value="<?=  $vals['ID'] ?>" <?php if ($DBType == $vals['ID'] ) {
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="customTable" value="<?= $customTable = (isset($dataSourceDetails['customTable'])) ? $dataSourceDetails['customTable'] : "";?>" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                    <label class="control-label col-md-3">

                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="card card-box">
                            <div class="card-head">
                                <header>Add Pie Chart(s) placeholder for <?= $getUserAccessPageDetails['PageMenuText'];?> <?= $userName; ?></header>
                            ...
                            <div class="card-body" id="bar-parent1">
                                <form action="<?php echo baseUrl . 'saveuserpageplaceholders'; ?>"
                                    ...
                                    <input type="hidden" name="PlaceholderType" value="5">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="control-label col-md-3">PieCharts page placeholder
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                <select class="form-control  select2-multiple" data-maximum-selection-length="1" multiple required name="PlaceholderId">
                                                    <option value="">Select</option>
                                                    <?php foreach ($getAllPCharts as $key => $value ) {
                                                        $selectedOption = "";

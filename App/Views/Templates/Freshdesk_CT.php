															    ...
															    <ul class="inbox-nav inbox-divider">
																	<?php   foreach ($_SESSION['PageDetails'] as $pageDetails) { 
																		...
																		if( $pageDetails['EnableTicketMenuLabel']){ 
																			...
																			<li <?php if($pageDetails['PageMenuText'] == $_GET['page_text'] ) {?> class= 'active' <?php } ?>><a  href ="<?php echo $path ;?>"> </i> <?  echo $pageDetails['PageMenuText'] ;?>
																			...
																			{ ?>
																				<span class="label mail-counter-style label-info " style="float: left;" id="<?php echo $pageDetails['PageMenuText'];?>">0</span>
																			<?php }
																				 ?>
																			</a></li>																

...
<div class="page-title-breadcrumb">
 ...
 <!--Del 1 -->    
			<div class="row" >
				...
				<div class="card card-box card-wrapper" style="display:none"> 
...
<!--Graph end --> 					
 <!--Table start -->                             
                                    	...
                                    	<table class="table display table-hover table-checkable order-column full-width" "cellspacing="0">
                                        <thead align="center" id="Table_1"> <tr></tr></thead>
										<tbody align="center" id="Table_1"> <tr></tr></tbody>
										<tfoot id="Table_1"><tr></tr></tfoot>
									  
                                    </table> <table class="mdl-data-table" cellspacing="0" style="width:100%" id="Table_1">  -->
									
									<div class="col-md-12">
									<div class="table-scrollable">
									<table class="table display table-hover table-checkable order-column full-width" id="Table_1">
                                        <thead ><tr></tr></thead>
										<tfoot ><tr></tr></tfoot>
                                    </table>

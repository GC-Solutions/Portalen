<?php include_once realpath(__DIR__) . '/layout/header_start.php'; ?>
<div class="page-wrapper">
    <?php include_once realpath(__DIR__) . '/layout/header_menu.php'; ?>
    <!-- start page container -->
    <div class="page-container">
        <?php include_once realpath(__DIR__) . '/layout/side_bar.php'; ?>
        <!-- start page content -->
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <?php include_once 'layout/submenus.php'; ?>
                <!-- start widget -->

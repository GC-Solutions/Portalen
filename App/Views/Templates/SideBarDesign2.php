                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12">
                        <div class="card card-box">
                            ...
                            <!--Graph end -->
                            <!--Table start -->
                            <div class="table-sidebar table-scrollable">

                                <table class="table-scrollable table-scrollable-nav table-scrollable-new-nav order-column full-width" cellspacing="0" id="Table_1">       
                                            <thead align="center">
                                                <tr></tr>
                                            </thead>
                                            <tfoot>
                                    ...
                                    <!--Side Bar Table -->
                                    <div id="mySidenav" class="side-bar-table side-bar-2">
                    ...
                    <div class="col-md-12 col-sm-12 col-12">
                        <div class="card card-box">
                            ...
                            <div class="card-body no-padding height-9">
                                ...
                                <table class="table table-checkable order-column full-width" cellspacing="0" id="Table_2">       
                                            <thead align="center">
                                                <tr></tr>
                                            </thead>
                                            <tfoot>
